...
public class BusinessRegisterActivity extends FatherActivity implements
    ...
    private void startGeeTest() {
        BusinessRegisterActivity.GtAppDlgTask gtAppDlgTask = new BusinessRegisterActivity.GtAppDlgTask();
        mGtAppDlgTask = gtAppDlgTask;
        mGtAppDlgTask.execute();

        if (!BusinessRegisterActivity.this.isFinishing()) {
            progressDialog = ProgressDialog.show(BusinessRegisterActivity.this, null, "Loading", true, true);
    ...
    private void getServerInfo() {
        showWaitDialog();
        RequestParams params = new RequestParams(ApiVariable.SellerProtocol());
        x.http().get(params, new WWXCallBack("SellerProtocol") {

            @Override
            public void onAfterSuccessOk(JSONObject data) {
                PublicWay.startWebViewActivity(BusinessRegisterActivity.this,
                        "注册协议", data.getString("Data"), WebViewActivity.DATA);
            }
...
//
//
//        RequestParams params = new RequestParams(ApiSeller.registerSMS());
...
//    }
    ...
    private void doRegister() {
        ...
        RequestParams params = new RequestParams(ApiSeller.register());
        params.addBodyParameter("mobile", phone);
        ...
        x.http().get(params, new WWXCallBack("Register") {
            ...
            public void onAfterSuccessOk(JSONObject data) {
                ...
                PublicWay.startBaseInfoActivity(BusinessRegisterActivity.this,
                        userId);
                finish();
            }
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result) {
                ...
                if (captcha.getSuccess()) {
                    openGtTest(BusinessRegisterActivity.this, captcha.getGt(), captcha.getChallenge(), captcha.getSuccess());
                } else {
                    ...
                    //WWToast.showShort("Geetest Server is Down.");
                    // 执行此处网站主的备用验证码方案
