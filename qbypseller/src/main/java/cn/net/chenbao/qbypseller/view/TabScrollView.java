...
public class TabScrollView extends LinearLayout implements OnGestureListener,
	...
	public interface OnScrollListener {
		 ...
		 * @date 2014-6-20
		 */
		void onScroll(boolean atStart, boolean atEnd, boolean atMiddle,
					  boolean noScroll);
	}
	...
	private void reLayoutViews() {
		...
		Log.i("XL", getWidth() + "__");

		switch (mStyle) {
		case TAB_STYLE_WEIGTH:
		...
		int width = (getResources().getDisplayMetrics().widthPixels - outerTabWidth)
				/ length;
	...
	private void addTabView(int width) {
		...
		mTabLayout.setLayoutParams(new LayoutParams(width,
	 ...
	 * 
	 * @author xl
	 * @date:2016-7-27下午2:23:46
	 * @description
	 * @param viewPager
	 * @param outerTabWidth
	 */
	public void setViewPager(ViewPager viewPager, int outerTabWidth) {
		this.outerTabWidth = outerTabWidth;
