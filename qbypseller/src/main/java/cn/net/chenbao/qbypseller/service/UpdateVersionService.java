package cn.net.chenbao.qbypseller.service;
...
public class UpdateVersionService extends Service {
        ...
        try{
            ...
            if (android.os.Environment.MEDIA_MOUNTED.equals(android.os.Environment
                ...
                updateDir = new File(Environment.getExternalStorageDirectory(),
                        "app/download/");
                updateFile = new File(updateDir.getPath(), "qbypseller.apk");
            }
                ...
                case DOWNLOAD_COMPLETE:
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {//兼容7.0
                        ...
                        Uri contentUri = FileProvider.getUriForFile(getApplicationContext(),
                                "cn.net.chenbao.qbypseller.fileprovider", updateFile);
    ...
    public void cleanUpdateFile() {
        ...
        File updateFile = new File("app/download/", "qbypseller.apk");
        if (updateFile.exists()) {
