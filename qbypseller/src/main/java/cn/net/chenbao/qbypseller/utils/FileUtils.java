...
public class FileUtils {
	...
	public static File createTmpFile(Context context) {
		...
		if (state.equals(Environment.MEDIA_MOUNTED)) {
			...
			String fileName = "cyk_" + timeStamp + "";
...
/**
	 ...
	 * @return
	 */
	public static String getCompressedImageFileUrl1(String filePath) {
		...
		final Bitmap compressedBitmap = getCompressedImageBitmap1(filePath, 0, 0);
	 ...
	 * @return
	 */
	private static Bitmap getCompressedImageBitmap(String filePath, int height,
			int width) {
		BitmapFactory.Options options = new BitmapFactory.Options();
		options.inJustDecodeBounds = true;
		BitmapFactory.decodeFile(filePath, options);
	...
	private static Bitmap getCompressedImageBitmap1(String filePath, int height,
		...
		options.inSampleSize = calculateImageInSampleSize(options, height,
				width);
		options.inSampleSize=options.inSampleSize>4?4:options.inSampleSize;
        ZLog.showPost("inSampleSize------"+options.inSampleSize);
		// Decode bitmap with inSampleSize set
		options.inJustDecodeBounds = false;
		return BitmapFactory.decodeFile(filePath, options);
