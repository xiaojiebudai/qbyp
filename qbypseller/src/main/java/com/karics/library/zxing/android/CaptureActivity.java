...
public final class CaptureActivity extends Activity implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        ll_head_left = findViewById(R.id.rl_head_left);
        findViewById(R.id.tv_head_left).setBackgroundResource(
                R.drawable.arrow_back);
        tv_head_center = (TextView) findViewById(R.id.tv_head_center);
        tv_head_center.setText("扫一扫");
        tv_head_center.setTextColor(getResources().getColor(R.color.white));
    ...
    public void handleDecode(Result rawResult, Bitmap barcode, float scaleFactor) {
        ...
        if (fromLiveScan) {
            ...
            WWToast.showShort("扫描成功");
            Intent intent = getIntent();
            intent.putExtra(Consts.KEY_DATA, rawResult.getText());
