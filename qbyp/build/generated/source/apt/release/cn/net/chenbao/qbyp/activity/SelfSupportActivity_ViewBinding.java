...
public class SelfSupportActivity_ViewBinding<T extends SelfSupportActivity> implements Unbinder {
  protected T target;
  ...
  @UiThread
  public SelfSupportActivity_ViewBinding(final T target, View source) {
    this.target = target;
