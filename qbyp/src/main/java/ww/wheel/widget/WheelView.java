...
package ww.wheel.widget;

import java.util.LinkedList;
import java.util.List;

import ww.wheel.widget.adapters.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    private int[] SHADOWS_COLORS = new int[]{0xefE9E9E9, 0xcfE9E9E9,
            0x3fE9E9E9};//0xefE9E9E9   0xcfE9E9E9  0x3fE9E9E9
    ...
    private void drawShadows(Canvas canvas) {
        ...
        bottomShadow
                .setBounds(0, center+offset, getWidth(), getHeight());
