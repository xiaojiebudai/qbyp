...
public class SellerManageAdapter extends FatherAdapter<AgencyInfo> {

	public SellerManageAdapter(Context ctx) {
		super(ctx);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = mInflater.inflate(
					R.layout.listview_seller_manage_item, parent, false);
