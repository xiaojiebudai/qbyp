...
import cn.net.chenbao.qbyp.utils.StatusBarUtil;
 ...
 * @description
 */
public abstract class FatherActivity extends FragmentActivity implements
        SeverErrorCallBack {
    ...
    protected void initTextHeadRigthImgFunc(int resId, OnClickListener listener) {
        View right = findViewById(R.id.rl_head_right_func);
        TextView text = (TextView) findViewById(R.id.tv_head_right_func);
        if (right != null && text != null) {
            right.setOnClickListener(listener);
            text.setBackgroundResource(resId);
        }
