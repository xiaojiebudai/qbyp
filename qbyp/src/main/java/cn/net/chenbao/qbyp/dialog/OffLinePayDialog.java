...
import android.widget.TextView;
	 ...
	 /***
	 * Description:检测输入金额dialog   Version：2.0
	 * 
	 * @title CertificateInputDialog.java
	 * @author ZXJ
	 * @date 2016-7-29
	 ***/
	public class OffLinePayDialog extends Dialog{
		private EditText ed_comment;
		private TextView tv_cancel, tv_ok;
		public OffLinePayDialog(Context context, int theme) {
			super(context, theme);
			setContentView(R.layout.dialog_offline_input);
