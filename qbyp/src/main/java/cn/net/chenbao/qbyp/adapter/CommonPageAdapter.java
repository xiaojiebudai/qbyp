...
import cn.net.chenbao.qbyp.view.TabScrollView.TabInterface;
 ...
 * @description 实例的时候设置加载模式
 */
public class CommonPageAdapter extends PagerAdapter implements
		OnPageChangeListener, TabInterface {
	...
	private List<FatherFragment> mFragments; // 每个Fragment对应一个Page
	...
	public CommonPageAdapter(Context mContext, List<String> mTabs,
			List<FatherFragment> fragments, FragmentManager fragmentManager,
	...
	public View getTabView() {
		...
		bottom.setBackgroundColor(mContext.getResources().getColor(R.color.yellow_ww));
		return bottom;
	}
